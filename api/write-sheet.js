...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const SHEET_API_URL = `https://script.google.com/macros/s/AKfycby_d-Q0vryRXKrayiIJYvz54zf8ji6q95rh_2wc4OsstFKEpsr9LH98enHnXxqE4fhe/exec?action=testWrite&name=Vercel测试&action=速度测试_${timestamp}`;
